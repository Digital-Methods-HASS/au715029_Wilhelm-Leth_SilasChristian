...
dir.create("RosFolderTest")
dir.create("Ros_output_data")
dir.create("Ros_fig_output")
dir.create("Ros_data")
dir.create("Ros_documents")
dir.create("Ros_scripts")
...
ggplot(data = "RosTableNoComments",
       mapping = aes(x="Enrollment-year", 
                     y = "Death-year"))+
  geom_point()

read.table("RosTableNoComments", header = FALSE, sep = "", quote = "", dec = ",", numerals = c("allow.loss", "warn.loss", "no.loss"), row.names = NULL, 
           col.names, as.is = !stringAsFactors, ...truncated...)
?sep
dir.create("testRos")
?read.csv
read.csv("RStudioProjects2/Ros_data/RosTableNoComments.csv")
RosTable <- read.csv("RStudioProjects2/Ros_data/RosTableNoComments.csv")
...
read.csv("RStudioProjects2/Ros_data/RosTableNoComments.csv", sep = ";")
RosTable <- read.csv("RStudioProjects2/Ros_data/RosTableNoComments.csv", sep = ";")
...
# name ("RostableAge.csv" is the name chosen), it will save in the repository, "Home" next to RStudiProjects2

write_csv(RosTableAge, "RStudioProjects2/Ros_data/RosTableAge.csv")
...
#For some reason my project is in two entirely different workspaces - and when I move one part the rest of it messes up
